...
import com.cursokotlin.appturismoconcellodeteo.databinding.FragmentNovasBinding

class NovasFragment : Fragment() {

    private var _binding: FragmentNovasBinding? = null
